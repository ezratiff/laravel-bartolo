<svg style="display:none;">
  ...
  <nav class="nav__cont">
<br><br>
    <a href="#" class="d-flex align-items-center mb-5 mb-md-0 me-md-auto text-decoration-none">
        <span class="fs-4 d-flex flex-column align-items-center">
            <img src="{{ Auth::user()->user_image ? asset('storage/img/user/' . Auth::user()->user_image) : asset('images/defaultImage.jpg') }}"
                class="mb-3" alt="" width="100" height="100" style="border-radius: 100%">
            <h4 class="text-white">{{ Auth::user()->first_name }} {{ Auth::user()->last_name }}</h4>
        </span>
    </a>
    <br><br>
    <ul class="nav">
      ...
      <li class="nav__items ">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
          <use xlink:href="/gender/create"></use>
        </svg>
       <a href="/gender/create">Add Gender</a>
      </li>

      <li class="nav__items ">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 35.6">
          <use xlink:href="/user/create"></use></svg>
        <a href="/user/create">Add User</a>
      </li>

      <li class="nav__items ">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 35.6">
          <use xlink:href="/process/logout"></use></svg>
